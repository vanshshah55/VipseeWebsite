...
//             description: 'High-performance laptops for all your business and personal needs.',
//             link: '/laptops', // Link to the Laptops page
//             relatedService: '/services/laptops', // Link to the related service
//         },
//         {
//             name: 'Printers/Scanners',
//             description: 'Reliable and efficient printers for home and office use.',
//             link: '/printers', // Link to the Printers page
//             relatedService: '/services/printers', // Link to the related service
//         },
//     ];
...
//                             <div
//                                 key={index}
//                                 className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl hover:bg-blue-900 hover:text-white transition duration-300"
//                             >
...
//                                     <Link
//                                         to={product.relatedService}
//                                         className="inline-block px-4 py-2 bg-gradient-to-r from-green-400 to-blue-500 text-white font-medium rounded-full shadow-lg hover:from-green-500 hover:to-blue-600 transition duration-300"
//                                     >
