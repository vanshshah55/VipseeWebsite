...
//                         <div className="box-border border-4 border-blue-900 p-8 bg-[#f9f9f9] text-gray-600 text-center rounded-lg xl:w-80 mx-auto">
...
//                 src={vipseelogo}
//                 alt="exclusive-partner"
//                 className="h-auto max-h-20 w-auto mx-auto" // Adjusted classes
//             />
//         </div>
//     </div>
// </div>
...
//                         <li className="mb-2">
//                             <HashLink to="/Privacy-Policy" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">Privacy Policy</HashLink>
//                         </li>
//                         <li className="mb-2">
...
//                         </li>
//                         <li className="mb-2">
//                             <HashLink to="#" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">Our Partners</HashLink>
//                         </li>
//                         <li className="mb-2">
                ...
                <div className="footer max-w-full mx-auto px-4 sm:px-6 bg-gray-100 border-t border-b py-30">
                    ...
                    <div className="col-span-6 md:col-span-6 lg:col-span-1 ml-7 mx-auto">
                        ...
                        <ul className="text-md">
                            ...
                            <li className="mb-2">
                                <HashLink smooth to="DemoProduct#/contact-us" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">ContactUs</HashLink>
                            </li>                                
                        </ul>
                    </div>
                    ...
                    <div className="col-span-12 text-center mx-auto lg:col-span-3 font-bold uppercase text-blue-900">
                        ...
                        <div className="mt-6 text-center">
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="inline-block px-6 py-3 bg-green-500 text-white font-semibold rounded-full shadow-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-opacity-50 transition"
                            >
                                Linktree <FaTree className="inline ml-2" />
                            </a>
                        </div>
    ...
    <div className="bg-gray-200 py-8 border-t border-gray-300 rounded-lg shadow-lg hover:bg-gray-300 transition duration-300 ease-in-out">
        <div className="text-center mx-auto px-4 lg:px-6">
            ...
            <p className="text-md text-gray-700 leading-relaxed max-w-3xl mx-auto">
                At Vipsee Infotech, we are committed to protecting your privacy and ensuring the security of your personal information. Click here for detailed information on our <span className="text-[#013289] hover:text-blue-600 transition duration-250 ease-in-out unerderline">Privacy Policy</span>.
            </p>
        </div>
    </div>
</Link>
