...
// import protergia from '../images/clients/uniview logo.png';
...
//                         </div>
//                         <h2 className="mt-4 mx-12 text-center text-xl lg:text-2xl font-semibold text-blue-900">Exclusive authorised partner</h2>
//                     </div>
