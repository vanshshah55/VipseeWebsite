...
//                             <h3 className="text-3xl  text-blue-900 font-bold">Vipsee Infotech specializes in</h3>
//                             <h3 className="text-3xl  text-blue-900 font-bold">top-quality surveillance,</h3>
//                             <h3 className="text-3xl  text-blue-900 font-bold">networking enhancement, and computer solutions.</h3>

//                             <div>
//                                 <p className='my-3 text-xl text-gray-600 font-semibold'>We offer Wholesale-Retail CCTV cameras, Networking equipment, and Laptops/Pcs, along with reliable Maintenance services.</p>
//                             </div>
//                             <div>
//                                 <p className='my-3 text-xl text-gray-600 font-semibold'>Our products come from leading Global vendors, ensuring Innovation and Efficiency.</p>
//                             </div>
                            
//                             <div>
//                                 <p className='my-3 text-xl text-gray-600 font-semibold'> We deliver tailored solutions to enhance Security, Connectivity, and Productivity for businesses and individuals.</p>
//                             </div>
